...
tags.Events['inomena:hptarget'] = 'UNIT_HEALTH UNIT_MAXHEALTH UNIT_CONNECTION PLAYER_FLAGS_CHANGED PARTY_MEMBER_ENABLE PARTY_MEMBER_DISABLE'
...
tags.Events['inomena:offline'] = 'UNIT_CONNECTION PLAYER_FLAGS_CHANGED UNIT_HEALTH PARTY_MEMBER_ENABLE PARTY_MEMBER_DISABLE'
