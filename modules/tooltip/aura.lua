...
TooltipDataProcessor.AddTooltipPostCall(Enum.TooltipDataType.UnitAura, function(tooltip, data)
	local found, _, _, _, _, _, caster = AuraUtil.FindAura(auraSpellPredicate, 'player', 'HELPFUL', data.id)
	if found and caster then -- and caster ~= 'player' then
