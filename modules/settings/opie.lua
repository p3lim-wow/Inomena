...
local RINGS = {
	...
	},
	{
		...
		-- custom house related stuff at the end
		{'ring', addonName .. 'Home'},
...
do
	...
	local function AddHouseTeleports()
		...
		if addon.PLAYER_FACTION_ID == 0 then
			ring:insert({'inomena.houseteleport2', c='FF2934', _t='househorde'})
			ring:insert({'inomena.houseteleport1', c='00ADF0', _t='housealliance'})
