...
local RINGS = addon:T({
	...
	-- (hidden) expansion/continent teleport rings
	{
		...
		{'toy', 266370}, -- Dundun's Abundant Travel Method
	...
	-- combined teleport ring
	{
		...
		{'toy', 141605, show='[in:broken isles/argus/bfa]'}, -- Flight Master's Whistle
		{'toy', 168862, show='[in:broken isles/argus/bfa]'}, -- G.E.A.R. Tracking Beacon
