...
for event, soundkitID in next, {
	...
	PET_BATTLE_QUEUE_PROPOSE_MATCH = 'UI_PET_BATTLES_PVP_THROUGH_QUEUE',
	RAID_BOSS_EMOTE = 'UI_RAID_BOSS_WHISPER_WARNING',
	RAID_BOSS_WHISPER = 'UI_RAID_BOSS_WHISPER_WARNING',
